...
class Info {
    ...
    add(id) {
        let row = '' +
            ...
            '    <div class="flex items-center text-white bg-yellow-400 rounded-full cursor-pointer transition-all duration-500 absolute -bottom-3 -left-4 hidden add-after" onclick="new AddSection().addComponent({target: this})" data-id="'+(id+1)+'" title="Add component after Quick info">\n' +
            ...
            row += '' +
            '        <div class="w-full flex justify-center items-center p-2 py-4 bg-white @if($bookmaker[\'restrictions\']) border-yellow-400 border-b-2 @endif mx-auto" style="max-width: 1200px">\n' +
