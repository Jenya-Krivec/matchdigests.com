...
@section('content')
    <main class="pt-20 font-serif">
        ...
        <div class="w-full flex justify-center items-center text-blue-700 pt-4 text-sm sm:text-base text-center bg-gray-100 relative">
            <a href="{{route('review', $bookmaker['key'])}}" class="bg-yellow-400 text-xs sm:text-lg border-2 border-yellow-400 text-black rounded-md hover:bg-gray-100 flex justify-center items-center transition-all duration-500 sm:mx-2 m-1 p-2 sm:px-4">{{trans('promocode.Review', ['bookmaker' => ''])}}</a>
            ...
            <a href="{{route('mobileapp', $bookmaker['key'])}}" class="bg-yellow-400 text-xs sm:text-lg border-2 border-yellow-400 text-black rounded-md hover:bg-gray-100 flex justify-center items-center transition-all duration-500 sm:mx-2 m-1 p-2 sm:px-4">@lang('promocode.Mobile App')</a>
        ...
        <form method="POST" action="{{route('admin.storePromoCode', ['key' => $bookmaker['key']])}}" enctype="multipart/form-data" class="w-full bg-gray-100 px-0 lg:px-28 pt-4 form">
            ...
            <input id="save-btn" class="flex justify-center items-center bg-yellow-400 rounded-full cursor-pointer transition-all duration-500 text-black h-10 w-10 text-xl fixed bottom-1/2 right-1" title="Save all" type="submit" value="&#x2713;">
        </form>
        <div id="add-section-btn" class="flex justify-center items-center bg-yellow-400 rounded-full cursor-pointer transition-all duration-500 text-black h-10 w-10 text-xl fixed bottom-1/2 left-1" title="Add Component">+</div>
        <div id="add-section" class="fixed border-2 border-yellow-400 bg-white rounded-md flex justify-center items-center -left-52 p-2 flex-col bottom-1/2 transition-all duration-500 z-20" style="transform: translateY(50%);">
            <button id="close-add-section-btn" class="text-black bg-yellow-400 text-xs rounded-full cursor-pointer transition-all duration-500 h-5 w-5 absolute -top-2 -right-2 pb-1" title="Close">x</button>
            <script>
            ...
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Caption">Add Caption</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Subtitle">Add Subtitle</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Paragraph">Add Paragraph</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Picture">Add Picture</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="List">Add List</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="ProsCons">Add Pros & Cons</button>
            <button class="w-full text-black border-2 border-yellow-400 bg-yellow-400 text-xs rounded-full flex justify-center items-center cursor-pointer transition-all duration-500 p-2 my-1" value="Sports">Add Sports</button>
