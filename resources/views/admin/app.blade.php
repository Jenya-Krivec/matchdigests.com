...
<header class="bg-white shadow-sm fixed w-full z-20 border-b-2 border-yellow-400">
    <nav class="flex items-center py-5 w-full">
        ...
        <div class="items-center text-white hidden sm:flex">
            <div class="relative">
                <a class="dropdown-item mx-2 text-black hover:bg-yellow-400 p-2 transition-all duration-500" href="{{route('admin.bookmakers')}}">Bookmakers</a>
                <a class="dropdown-item mx-2 text-black hover:bg-yellow-400 p-2 transition-all duration-500" href="{{route('admin.payments')}}">Payments</a>
                <a class="dropdown-item mx-2 text-black hover:bg-yellow-400 p-2 transition-all duration-500" href="{{route('admin.currencies')}}">Currencies</a>
                <a class="dropdown-item mx-2 text-black hover:bg-yellow-400 p-2 transition-all duration-500" href="{{route('admin.sports')}}">Sports</a>
            </div>
        </div>
         <!--Information-->
        ...
        <div id="information-menu" class="fixed -right-1/2 w-1/2 top-22 transition-all bg-white z-40 p-2 border-2 border-yellow-400 overflow-y-auto" style="height: calc(100vh - 90px);">
            @yield('information')
        </div>
...
<div class="fixed top-0 left-0 right-0 bottom-0 bg-yellow-400 z-50 flex lg:hidden justify-center items-center flex-col">
    <img src="{{asset('img/logo/logo.png').'?v='.filemtime('img/logo/logo.png')}}" class="w-10 h-10 logo" alt="MATCHDIGESTS">
    <p class="text-sm text-white mt-2">To edit, open the website on a desktop</p>
</div>
<footer class="bg-white py-5 border-t-2 border-b-2 border-yellow-400">
    <p class="text-sm text-black text-center">&copy; {{ date('Y') }} MATCHDIGESTS</p>
</footer>
</body>
