...
@section('content')
    <main class="xl:px-20 sm:py-5 px-3 py-2 m-auto pt-24 sm:pt-24 bg-gray-100">
        ...
        @endforeach
        <a href="{{ route('admin.editBookmaker', ' ') }}" class="flex justify-center items-center bg-yellow-400 rounded-full hover:bg-yellow-500 cursor-pointer transition-all duration-500 text-black h-10 w-10 text-xl mx-auto my-4">+</a>
    </main>
@endsection
